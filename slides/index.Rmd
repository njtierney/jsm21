...
`r icons::fontawesome(name = 'link', 'solid')` **bit.ly/njt-jsm21** 

`r icons::fontawesome$brands$twitter` **nj_tierney**
...
.large.pull-left[
`r icons::fontawesome("layer-group", "solid")` Overplotting
...
.pull-right.large[
`r icons::fontawesome$solid$bolt` with `sample_n_keys()` & `stratify_keys()`
...
.large[
`r icons::fontawesome("mortar-pestle", "solid")` More features (summaries)

`r icons::fontawesome$solid$binoculars` Generalise beyond longitudinal data 

`r icons::fontawesome$solid$compass` Explore stratification process

`r icons::fontawesome$solid$code` Work with `dplyr::across()` & `dplyr::pick()`
]
...
.large[
`r icons::fontawesome(name = "box-open", "solid")` [feasts](http://feasts.tidyverts.org/)

`r icons::fontawesome(name = "box-open", "solid")` [tsibble](http://tsibble.tidyverts.org/)

`r icons::fontawesome$solid$newspaper` [Time series graphics using feasts](https://robjhyndman.com/hyndsight/feasts/)

`r icons::fontawesome$solid$newspaper` [Feature-based time series analysis](https://robjhyndman.com/hyndsight/fbtsa/)
]
...
.medium[
`r icons::fontawesome(name = "layer-group", "solid")` Slides made using [xaringan](https://github.com/yihui/xaringan)

`r icons::fontawesome$solid$seedling` Extended with [xaringanthemer](https://github.com/gadenbuie/xaringanthemer)

`r icons::fontawesome$solid$palette` Colours modified from [ochRe::lorikeet](https://github.com/ropenscilabs/ochRe)

`r icons::fontawesome(name = "text-height", "solid") ` Header font is **Josefin Sans**

`r icons::fontawesome(name = "text-height", "solid") ` Body text font is **Montserrat**

`r icons::fontawesome$solid$code` Code font is **Fira Mono**
]
...
.large[
`r icons::fontawesome(name = "box-open", "solid") ` [brolgar.njtierney.com](http://brolgar.njtierney.com/)

`r icons::fontawesome$solid$link` [bit.ly/njt-jsm21](https://bit.ly/njt-jsm21)

`r icons::fontawesome$brands$twitter` nj_tierney

`r icons::fontawesome$brands$github` njtierney

`r icons::fontawesome(name = "paper-plane", "solid")` nicholas.tierney@gmail.com
