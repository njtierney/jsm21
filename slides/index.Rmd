---
title: .large[Tangling is easy but untangling is hard]
...
subtitle: "**bit.ly/njt-jsm21**, **nj_tierney**"
output:
...
# .large[Tangling is easy. Untangling is hard]
...
`r icons::icon_style(icons::fontawesome(name = 'link', 'solid'), fill = nipa$purple)` **bit.ly/njt-jsm21** 
...
layout: true
<div class="my-footer"><span>bit.ly/njt-jsm21 • @nj_tierney</span></div> 
...
.large.pull-left[
`r icons::icon_style(icons::fontawesome("layer-group", "solid"), fill = nipa$purple)` Overplotting
...
.pull-right.large[
`r icons::icon_style(icons::fontawesome$solid$bolt, fill = nipa$purple)` with `sample_n_keys()` & `stratify_keys()`
...
.large[
`r icons::icon_style(icons::fontawesome("mortar-pestle", "solid"), fill = nipa$purple)` More features (summaries)

`r icons::icon_style(icons::fontawesome$solid$binoculars, fill = nipa$purple)` Generalise beyond longitudinal data 

`r icons::icon_style(icons::fontawesome$solid$compass, fill = nipa$purple)` Explore stratification process

`r icons::icon_style(icons::fontawesome$solid$code, fill = nipa$purple)` Work with `dplyr::across()` & `dplyr::pick()`
]
...
.large[
`r icons::icon_style(icons::fontawesome(name = "box-open", "solid"), fill = nipa$purple)` [feasts](http://feasts.tidyverts.org/)

`r icons::icon_style(icons::fontawesome(name = "box-open", "solid"), fill = nipa$purple)` [tsibble](http://tsibble.tidyverts.org/)

`r icons::icon_style(icons::fontawesome$solid$newspaper, fill = nipa$purple)` [Time series graphics using feasts](https://robjhyndman.com/hyndsight/feasts/)

`r icons::icon_style(icons::fontawesome$solid$newspaper, fill = nipa$purple)` [Feature-based time series analysis](https://robjhyndman.com/hyndsight/fbtsa/)
]
...
.medium[
`r icons::icon_style(icons::fontawesome(name = "layer-group", "solid"), fill = nipa$purple)` Slides made using [xaringan](https://github.com/yihui/xaringan)

`r icons::icon_style(icons::fontawesome$solid$seedling, fill = nipa$purple)` Extended with [xaringanthemer](https://github.com/gadenbuie/xaringanthemer)

`r icons::icon_style(icons::fontawesome$solid$palette, fill = nipa$purple)` Colours modified from [ochRe::lorikeet](https://github.com/ropenscilabs/ochRe)

`r icons::icon_style(icons::fontawesome(name = "text-height", "solid"), fill = nipa$purple) ` Header font is **Josefin Sans**

`r icons::icon_style(icons::fontawesome(name = "text-height", "solid"), fill = nipa$purple) ` Body text font is **Montserrat**

`r icons::icon_style(icons::fontawesome$solid$code, fill = nipa$purple)` Code font is **Fira Mono**
]
...
.large[
`r icons::icon_style(icons::fontawesome(name = "box-open", "solid"), fill = nipa$purple) ` [brolgar.njtierney.com](http://brolgar.njtierney.com/)

`r icons::icon_style(icons::fontawesome$solid$link, fill = nipa$purple)` [bit.ly/njt-jsm21](https://bit.ly/njt-jsm21)

`r icons::icon_style(icons::fontawesome$brands$twitter, fill = nipa$purple)` nj_tierney

`r icons::icon_style(icons::fontawesome$brands$github, fill = nipa$purple)` njtierney

`r icons::icon_style(icons::fontawesome(name = "paper-plane", "solid"), fill = nipa$purple)` nicholas.tierney@gmail.com
